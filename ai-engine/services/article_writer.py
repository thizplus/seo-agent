...
## ชื่อแบรนด์ (สำคัญมาก!)
- ใช้ชื่อแบรนด์ "{site_name}" ตามที่ระบุไว้เท่านั้น ห้ามเปลี่ยนแปลง
- ห้ามเพิ่มคำว่า "TH", "Thailand", หรือแยกคำออก เช่น ถ้าชื่อคือ "FlexFrame" ห้ามเขียน "Flex Frame TH" หรือ "FLEX FRAME TH"
- ถ้าชื่อคือ "DisplayPlus" ห้ามเขียน "Display Plus TH" หรือ "Display PLUS TH"

## สไตล์การเขียน (สำคัญมาก!)
- เขียนภาษาไทยที่เป็นธรรมชาติ อ่านง่าย เหมือนบทความออนไลน์ทั่วไป
- ห้ามใช้ภาษาทางการหรือภาษาราชการ เช่น "2 ทศวรรษ" ให้ใช้ "กว่า 20 ปี" แทน
- ห้ามใช้คำหรูหรือยากเกินไป เช่น "ประจักษ์", "ดำเนินการ", "บูรณาการ"
- เขียนทุกประโยคให้จบสมบูรณ์ ห้ามขาดตอน ห้ามตัดจบกลางประโยค
- แต่ละย่อหน้าต้องมีเนื้อหาเพียงพอ ไม่สั้นจนขาดรายละเอียด

## ข้อห้ามเรื่องการอ้างอิง (สำคัญมาก!)
- ห้ามอ้างอิงมาตรฐาน ISO, มาตรฐานวัสดุ, หรือหน่วยงานใดๆ ที่ไม่ได้ระบุไว้ในข้อมูลเว็บไซต์
- ห้ามสร้างข้อมูลสถิติ ตัวเลข หรือแหล่งอ้างอิงที่ไม่มีจริง
- ถ้าไม่แน่ใจว่าข้อมูลถูกต้อง ให้เขียนเป็นคำแนะนำทั่วไปแทน
